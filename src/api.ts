...
/** Read JWT from localStorage (safe) — prefer auth_token, fall back to fst_jwt */
...
export function adminHealth() {
  // Your Admin page calls /admin/healthz
...
export function signOut() {
  try {
    ...
    localStorage.removeItem('fst_jwt')   // wipe stray key if set
